  ...
  <section id="container">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-md-12">
					<h3 class="page-header"> Timesheet for Sam Winchester</h3>
...
<!--HOURS TIMESHEET-->				   
    ...
    <div class="col-md-6"><!--START COL TITLE-->
		<h3>Total Yearly Hours: 27 </h3>
		</div> <!--END COL TITLE-->
		
	<div class="col-md-6"><!--START COL TITLE-->
		<div class="two-buttons">
			<a href="confirmation-timesheet.aspx">
			<div class="save-button"><!--START DIV EDIT BUTTON-->
				<p>Save</p>
				</div>  <!--END DIV EDIT BUTTON-->
			</a>
			
			<a href="add-time.aspx">
			<div class="save-button"><!--START DIV EDIT BUTTON-->
				<p>Add time</p>
				</div>  <!--END DIV EDIT BUTTON-->
			</a>
                              ...
                              <tr>
                                  <td>
                                  	<div class="form-group">
   										<input class="form-control" id="focusedInput" type="text" value="03-02-2017">
   									</div>
                                  </td>
                                  
                                  <td>
                                  <div class="form-group">
   										<input class="form-control" id="focusedInput2" type="text" value="9:00am">
   									</div>
                                  </td>
                                  ...
                                  <td>
                                  <div class="form-group">
   										<input class="form-control" id="focusedInput3" type="text" value="12:00pm">
   									</div>
                                  </td>
                                  
                                  <td>
                                  <div class="form-group">
   										<input class="form-control" id="focusedInput4" type="text" value="3">
   									</div>
                                  </td>
                              </tr>
                              <tr>
