                              ...
                              <tr>
                                <td>
                                 <div class="form-group">
   										<input class="form-control" id="focusedInput" type="text" value="00-00-2010">
   								</div>
								  </td>
                                 <td>
                                  <div class="form-group">
   										<input class="form-control" id="focusedInput1" type="text" value="00:00am">
								  </div>
								  </td>
                                 <td>
                                  <div class="form-group">
   										<input class="form-control" id="focusedInput2" type="text" value="00:00am">
								  </div>
								  </td>
                                 <td>
                                  <div class="form-group">
   										<input class="form-control" id="focusedInput3" type="text" value="0">
								  </div>
								  </td>
                              </tr>
